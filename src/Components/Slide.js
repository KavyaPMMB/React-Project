  ...
  return (
    <div>
      ...
      <Carousel.Item interval={15000}>
        ...
        />
       <Carousel.Caption>
  <h1 style={{color:'white',fontWeight:'600',marginBottom:"30%",fontFamily:'Montserrat',color:"greenyellow"}}>{display.label}</h1>
</Carousel.Caption>
